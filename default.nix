...
let combineOverrides = old: new: (old // new) // {
    ...
    extendHaskellPackages = haskellPackages: makeRecursivelyOverridable haskellPackages {
      overrides = self: super: {
        ...
        pure-bloom-limiter = self.callPackage (hackGet ./packages/pure-bloom-limiter) {};
        ...
        pure-conjurer     = self.callPackage (hackGet ./packages/pure-conjurer)     {};
        pure-contenteditable = self.callPackage (hackGet ./packages/pure-contenteditable) {};
        pure-contexts     = self.callPackage (hackGet ./packages/pure-contexts)     {};
        pure-convoker     = self.callPackage (hackGet ./packages/pure-convoker)     {};
        ...
        pure-shadows      = self.callPackage (hackGet ./packages/pure-shadows)      {};
        ...
        pure-statusbar    = self.callPackage (hackGet ./packages/pure-statusbar)    {};
